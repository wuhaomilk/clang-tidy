...
bool ClangTidyDiagnosticConsumer::diagnosticMatchesSuppressChecksFilter(const Diagnostic &Info) {
  ...
  llvm::errs() << "FileName: " << FileName << ": " << getExcludeHeaderFilter()->match(FileName) << "\n";
  if (!getExcludeHeaderFilter()->match(FileName)) {
    return true;
  }
...
void ClangTidyDiagnosticConsumer::checkFilters(SourceLocation Location,
  ...
  llvm::errs() << "sss FileName: " << FileName << "   LineNumber: " << LineNumber << "\n";
...
llvm::Regex *ClangTidyDiagnosticConsumer::getExcludeHeaderFilter() {
  if (!ExcludeHeaderFilter)
    ExcludeHeaderFilter =
        std::make_unique<llvm::Regex>(*Context.getOptions().ExcludeHeaderFilterRegex);
